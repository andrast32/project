<?php 
    ...
    $kunjungan_query = $mysqli->query("SELECT COUNT(*) AS total_kunjungan FROM kunjungan_anggota WHERE id_siswa = '$id_user_session'");
    $kunjungan = $kunjungan_query->fetch_assoc();
    $poin_kunjungan = $kunjungan['total_kunjungan'] * 2;

    $peminjaman_query = $mysqli->query("SELECT COUNT(*) AS total_peminjaman FROM peminjaman_anggota WHERE id_siswa = '$id_user_session'");
                                        ...
                                        <div class="widgets-container">
                                            <div class="blog-author-widget widget-item">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <img src="../../templates/uploads/anggota/<?php echo $_SESSION['foto']?>" class="rounded-circle flex-shrink-0" style="margin-left: 11rem;" alt="Foto">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="?settings=reset_pw" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="nis" id="nis" value="<?php echo $_SESSION['nis']?>" readonly>
                    <div class="form-group">
                        <label for="NIS">NIS</label>
                        <input type="text" name="nis" id="nis" class="form-control" value="<?php echo $_SESSION['nis']?>" readonly>
                    </div>
...
<?php
    ...
    while ($data = mysqli_fetch_array($anggota)) {
        $id_modal = "cetak-" . $data['id_siswa'];
        $id_print = "print-area-" . $data['id_siswa'];
?>
